...
routes
    ...
    .get(function (req, res) {
        Products.find({
            ...
            .select({"product_price": 1, "product_id" : 1, "product_name": 1, "product_category": 1, "product_quantity": 1, "_id": 1})
            .then(product => {
                res.send(product);
            })
            .catch(err => {
    ...
    .get(function (req, res) {
        Products.find({
            "product_id": req.params.sku
        }, function (err, obj) {
            //res.json(obj);
        })
            .select({"product_price": 1, "product_id" : 1, "product_name": 1, "product_category": 1, "product_quantity": 1,"quantity_sold": 1, "min_stock_qty": 1, "_id": 1})
            .then(product => {
...
routes
    ...
    .get(function (req, res) {
        Products.find({
            ...
            .select({"product_price": 1, "product_id" : 1, "product_name": 1, "product_category": 1, "product_quantity": 1,"min_stock_qty": 1})
            .then(product => {
                res.send(product);
            })
            .catch(err => {
